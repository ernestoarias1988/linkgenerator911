...
class MainActivity : AppCompatActivity(), AdvancedWebView.Listener {
    ...
    fun beginOAuthFlow() {
        Config.release().then { value ->
            mAccount = FirefoxAccount(value, "20f7931c9054d833", "http://els1.911salta.gob.ar:8080/fxa/android-redirect.html")
    ...
    override fun onPageStarted(url: String, favicon: Bitmap?) {
        if (url.startsWith("http://els1.911salta.gob.ar:8080/fxa/android-redirect.html")) {
